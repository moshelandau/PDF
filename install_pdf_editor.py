#!/usr/bin/env python3
"""
PDF Editor - One-Command Installer
Run this on any Windows PC with Python installed:
    python install_pdf_editor.py

It will:
1. Create C:\\PDFEditor folder
2. Install all dependencies
3. Create the app files
4. Put a shortcut on your Desktop
"""
...
INSTALL_DIR = os.path.join("C:\\", "PDFEditor")

def main():
    print("=" * 50)
    print("  PDF Editor - Installer")
    print("=" * 50)
    print()

    # 1. Create folder
    os.makedirs(INSTALL_DIR, exist_ok=True)
    print(f"[1/4] Created folder: {INSTALL_DIR}")

    # 2. Install packages
    print("[2/4] Installing packages...")
    packages = ["PyPDF2>=3.0.0", "PyMuPDF>=1.23.0", "Pillow>=9.0.0", "pytesseract>=0.3.10"]
    subprocess.check_call([sys.executable, "-m", "pip", "install"] + packages)
    print()

    # 3. Write app files
    print("[3/4] Creating app files...")

    with open(os.path.join(INSTALL_DIR, "pdf_editor.py"), "w", encoding="utf-8") as f:
        f.write(APP_CODE)
    print(f"  Written: {os.path.join(INSTALL_DIR, 'pdf_editor.py')}")
    ...
    if os.path.exists(desktop):
        ...
        print(f"  Shortcut: {bat_path}")
    else:
        print("  Could not find Desktop folder.")
        print(f"  Run manually: python {os.path.join(INSTALL_DIR, 'pdf_editor.py')}")

    print()
    print("=" * 50)
    print("  Done! Double-click 'PDF Editor' on your Desktop.")
    print("=" * 50)
    print()
    print("OPTIONAL: For smart OCR auto-rotate, install Tesseract:")
    print("  https://github.com/tesseract-ocr/tesseract/releases/download/5.5.0/tesseract-ocr-w64-setup-5.5.0.20241111.exe")
    print()
    input("Press Enter to exit...")


# ============================================================
# Embedded app code below
# ============================================================
